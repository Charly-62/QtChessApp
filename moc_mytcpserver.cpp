...
QT_MOC_LITERAL(1, 12, 18), // "clientStateChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10), // "clientInfo"
QT_MOC_LITERAL(4, 43, 12), // "serverStatus"
QT_MOC_LITERAL(5, 56, 6), // "status"
QT_MOC_LITERAL(6, 63, 16), // "client_Connected"
QT_MOC_LITERAL(7, 80, 19), // "client_Disconnected"
QT_MOC_LITERAL(8, 100, 18), // "onClientConnecting"
QT_MOC_LITERAL(9, 119, 20) // "onClientDisconnected"

    },
    "MyTCPServer\0clientStateChanged\0\0"
    "clientInfo\0serverStatus\0status\0"
    "client_Connected\0client_Disconnected\0"
    "onClientConnecting\0onClientDisconnected"
};
...
void MyTCPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clientStateChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->serverStatus((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->client_Connected(); break;
        case 3: _t->client_Disconnected(); break;
        case 4: _t->onClientConnecting(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTCPServer::clientStateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyTCPServer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTCPServer::serverStatus)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTCPServer::client_Connected)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MyTCPServer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTCPServer::client_Disconnected)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void MyTCPServer::clientStateChanged(QString _t1)
{
...
// SIGNAL 1
void MyTCPServer::serverStatus(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void MyTCPServer::client_Connected()
{
